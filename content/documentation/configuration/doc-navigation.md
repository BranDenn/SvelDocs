...
| `private?` | `boolean \| TRole \| TRole[]` | Determines if this tab and its groups/pages require auth. Read the [SSR auth section](/docs/guides/server-side-rendering#auth) for more info. |
...
| `private?` | `boolean \| TRole \| TRole[]` | Determines if this group and its pages require auth. Read the [SSR auth section](/docs/guides/server-side-rendering#auth) for more info. |
...
| `private?` | `boolean \| TRole \| TRole[]` | Determines if this page requires auth. Read the [SSR auth section](/docs/guides/server-side-rendering#auth) for more info. |