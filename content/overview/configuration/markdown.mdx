...
<script lang="ts">import Alert from '$lib/components/ui/alert/alert.svelte'</script>
...
<Alert type="warning">
	All frontmatter attributes from markdown files are exposed plublicly in the api and search
	results.
</Alert>
...
<Alert type="note">The exported component must have the same name as the default html tags.</Alert>
