...
<div class={cn('relative w-full', wrapperClass)}>
	...
	/>
	<SearchIcon
		class="text-muted-foreground peer-hover:text-foreground peer-focus-visible:text-foreground absolute top-1/2 left-2 size-4 -translate-y-1/2 transition-colors"
	/>
	{#if hasValue}
		<Tooltip.Root>
			<Tooltip.Trigger
